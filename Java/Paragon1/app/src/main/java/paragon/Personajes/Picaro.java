...
public class Picaro extends Personaje {
    ...
    public Picaro(String nombre, int hp, int mp, int fuerza, int inteligencia, int destreza) throws Exception {
        super(nombre, hp, mp, fuerza, inteligencia, destreza);
        logger.info("Pícaro creado: " + this.nombre);
    }
    ...
    public void atacar(Personaje objetivo) {
        ...
        logger.info(nombre + " atacó rápidamente causando " + daño + " de daño.");
    }
    ...
    public int poderTotal() {
        int poder = (int) ((destreza * nivel) * 1.5);
